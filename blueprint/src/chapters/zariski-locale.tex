...
\begin{definition}[Order and Operations on Radical Ideals]
  ...
  \lean{Rad.instLE,Rad.instInf,Rad.instSup}
  \leanok
...
\begin{lemma}[Properties of Basic Opens]
  ...
  \uses{def:basic-open-set}
  \lean{Rad.basicOpen_one,Rad.basicOpen_zero,Rad.basicOpen_mul,Rad.basicOpen_pow}
  \leanok
...
\begin{lemma}[Radical Membership and Basic Opens]
  ...
  \uses{def:basic-open-set}
  \lean{Rad.mem_radical_iff_basicOpen_le}
  \leanok
