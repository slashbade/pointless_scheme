...
\begin{definition}[Sheaf on a Locale]
  ...
  \lean{PointlessScheme.LocaleSheaf}
...
\begin{lemma}[Basic Properties of Localizations]
  ...
  \lean{Localization.Away.instCommRing, IsLocalization.Away.invSelf}
  \leanok
...
\begin{definition}[Structure Sheaf on Zariski Locale]
  ...
  \lean{PointlessScheme.StructureSheaf}
...
\begin{lemma}[Restriction Maps are Well-Defined]
  ...
  \lean{PointlessScheme.StructureSheaf.res}
...
\begin{lemma}[Restriction Maps Compose]
  ...
  \lean{PointlessScheme.StructureSheaf.res_comp}
...
\begin{definition}[Extension to Arbitrary Radical Ideals]
  ...
  \lean{PointlessScheme.StructureSheaf.sections}
...
\begin{theorem}[Sheaf Property of the Structure Sheaf]
  ...
  \lean{PointlessScheme.StructureSheaf.isSheaf}
...
\begin{lemma}[Stalk at a Point]
  \label{lemma:stalk-at-point}
  \lean{PointlessScheme.StructureSheaf.stalk}
  \uses{def:structure-sheaf-zariski}

  For a prime ideal $\mathfrak{p} \in \mathrm{Spec}(R)$, the stalk of $\mathcal{O}_{\mathrm{Spec} R}$ at $\mathfrak{p}$ is:
  $$\mathcal{O}_{\mathrm{Spec} R, \mathfrak{p}} \cong R_{\mathfrak{p}}$$
  where $R_{\mathfrak{p}}$ is the localization of $R$ at $\mathfrak{p}$.
\end{lemma}

\begin{proof}
  The stalk is the colimit $\varinjlim_{f \notin \mathfrak{p}} R_f$.

  For $f \notin \mathfrak{p}$, we have $D(f) \not\subseteq \mathfrak{p}$, so $f$ is not in the prime ideal.

  The colimit over all such $f$ is exactly $R_{\mathfrak{p}}$, by the universal property of localization.
\end{proof}
